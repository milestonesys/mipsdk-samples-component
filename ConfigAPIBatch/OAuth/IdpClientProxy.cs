...
namespace ConfigAPIBatch.OAuth
{
	/// <summary>
	...
	public static class IdpClientProxy
	{
		...
		/// </summary>
		public static async Task<AccessTokenResponse> GetAccessTokenForBasicUserAsync(string address, int port, string userName, string password)
		{
			HttpClient client = new HttpClient();
			client.BaseAddress = GetIdpUri(address, port);
		...
		/// </summary>
		/// <param name="address">The base address of the identity server.</param>
		/// <param name="port"></param>
		/// <param name="credentials">The credentials used for authentication.</param>
		public static async Task<AccessTokenResponse> GetAccessTokenForWindowsUserAsync(string address, int port, ICredentials credentials)
		{
