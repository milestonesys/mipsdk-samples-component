...
{
    public class ConfigApiServiceOAuthHelper
	{
		private const string CommandServiceOAuthPath = "ManagementServer/ConfigurationApiServiceOAuth.svc";
		...
		public static Uri CalculateServiceUrl(string hostName, int port)
		{
			var baseUri = new UriBuilder(port == 443 ? Uri.UriSchemeHttps : Uri.UriSchemeHttp, hostName, port).Uri;
